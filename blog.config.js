...
const BLOG = {
  AUTHOR: '一只棒棒鸡', // 作者
  BIO: '娇羞猛男塞尔达', // 作者简介
  LINK: 'https://notion-next-bo6r6nfxf-yzbbj.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '5c5374ddcd23473b9cd6ab04ea347461', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '704900430@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/yzbbj',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'yzbbj/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHotcAQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHotcAc4CQWhU', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Sylvia777 BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
